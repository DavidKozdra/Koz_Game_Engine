...
`Koz_Engine_Lib` is a reusable, game-agnostic engine layer.
...
Use [migration-roadmap.md](docs/migration-roadmap.md) as the source of truth for the final standalone target.
